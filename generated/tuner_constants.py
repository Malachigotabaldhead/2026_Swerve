...
class TunerConstants:
    ...
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 9.15
    ...
    _front_left_encoder_offset: units.rotation = -0.28515625
    _front_left_steer_motor_inverted = True
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(9.875)
    ...
    _front_right_encoder_offset: units.rotation = 0.4921875
    _front_right_steer_motor_inverted = True
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(9.875)
    ...
    _back_left_encoder_offset: units.rotation = -0.109375
    _back_left_steer_motor_inverted = True
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-9.875)
    ...
    _back_right_encoder_offset: units.rotation = -0.365478515625
    _back_right_steer_motor_inverted = True
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-9.875)
